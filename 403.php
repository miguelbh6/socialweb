<?php
	...
	$utility->gravaLogUsuario($TLU_ERRO403, "Erro 403: ".$_SERVER['REQUEST_URI']);
?>
...
<br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
	<table width="50%" id="customers" border="0" align="center">
	<tr>
		<td align="center" height="35px">
			<span class="barranavegacao1">
				<b>Erro 403 - Acesso Negado a este Site!</b>
			</span>
			<br/><br/><br/><br/><br/>

			<span class="barranavegacao">
				<b>Seu IP "<?php echo Utility::getIPLogado(); ?>" está fora da faixa do Brasil aceita pelo sistema, entre em contato com a prefeitura.</b>
			</span>
		</td>
	</tr>
	</table>
