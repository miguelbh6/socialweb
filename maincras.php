<?php
	...
	if (!Utility::usuarioLogadoIsCras()) {
		global $TLU_ACESSOINVALIDO;
		$utility->gravaLogUsuario($TLU_ACESSOINVALIDO, "Tela: Main - Canal do CRAS");
		Utility::redirect("index.php");
	}
?>
...
<br style="clear:left"/>
    ...
    <div id="coluna2xx">
	  ...
	  <tr>
		...
		<div class="titulosPag">SocialWeb - Sistema de Assistência Social - Canal do CRAS</div>
	...
	<tr>
	  <td>
	    <br/>
		<?php /*echo $utility->getDadosPrefeitura("pre_msgcanalcras");*/ ?>
	  </td>
	</tr>
	</table>
