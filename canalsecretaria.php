...
if ((isset($_POST['usu_login'])) && (isset($_POST['usu_senha'])) && (isset($_GET['acao'])) && ($_GET['acao'] == "validalogin")) {
	...
	$msg = "";
	$sucess = $utility->validaUnidadesLoginSenha($uso_codigo, $usu_login, $usu_senha, $msg, true, false, false);

	if (!$sucess) {
		$utility->gravaLogUsuario($TLU_LOGININVALIDO, "Login: $usu_login - Senha: $usu_senha - Canal da Secretaria");
	} else {
		Utility::redirect("main.php");
	}
}
...
<?php if (false) {/*if ($utility->getDadosPrefeituraBD("pre_bloquearcanalsecretaria")) {
...
<div align="left">
<div id="content">
<form name="idform" id="idform" method="post" action="canalsecretaria.php?acao=validalogin">
