...
if ((isset($_POST['usu_login'])) && (isset($_POST['usu_senha'])) && (isset($_GET['acao'])) && ($_GET['acao'] == "validalogin")) {
	...
	if (!$sucess) {
		$utility->gravaLogUsuario($TLU_LOGININVALIDO, "Login: $usu_login - Senha: $usu_senha - Canal do Secretário");
	} else {*/
		Utility::redirect("main.php");
	//}
}
...
<div class="titulosPag">Canal da Secretaria</div>
<br/>

<?php /*if ($utility->getDadosPrefeituraBD("pre_bloquearcanalsecretaria")) {
			echo $utility->getDadosPrefeituraBD("pre_msgcanalsecretaria");
} else {*/ ?>

<div align="left">
<div id="content">
<form name="idform" id="idform" method="post" action="canalsecretariaassistsocial.php?acao=validalogin">
<fieldset class="classfieldset1" style="width:580px">
   <legend class="classlegend1">Canal da Secretaria</legend>
