...
(function(global, factory) {
	 ...
	 */
	function OnOff(elem, options, desativado) {

		// Allow instantiation without `new` keyword
		if (!(this instanceof OnOff)) {
			return new OnOff(elem, options, desativado);
		}
	 ...
	 */
	$.fn.onoff = function(options, desativado = false) {
		...
		return this.each(function() {
			new OnOff(this, options, desativado);
		});
	};
