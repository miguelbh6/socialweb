<?php
	...
	if (!Utility::usuarioLogadoIsSecretaria()) {
		global $TLU_ACESSOINVALIDO;
		$utility->gravaLogUsuario($TLU_ACESSOINVALIDO, "Tela: Main - Canal do Secretário");
		Utility::redirect("index.php");
	}
?>
...
<br style="clear:left"/>
    ...
    <div id="coluna2xx">
	  ...
	  <tr>
		...
		<div class="titulosPag">SocialWeb - Sistema de Assistência Social - Canal do(a) Secretário(a)</div>

			<?php if (Utility::usuarioLogadoAutorizaProcedimento()) { ?>
				<?php require_once "avisoprocedimentosaautorizar.php"; ?>
			<?php } ?>

			<?php if (Utility::AvisoProcedimentosAutorizados()) { ?>
				<?php require_once "avisoprocedimentosautorizados.php"; ?>
			<?php } ?>

			<?php require_once "rel_saldolabclinicashospitais1.php"; ?>
	...
	<tr>
	  <td>
	    <br/>
		<?php echo $utility->getDadosPrefeitura("pre_msgcanalsecretaria"); ?>
	  </td>
	</tr>
	</table>
