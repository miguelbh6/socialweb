<?php
	...
	if (!Utility::usuarioLogadoIsSecretaria()) {
		...
		$utility->gravaLogUsuario($TLU_ACESSOINVALIDO, "Tela: Main - Canal da Secretaria");
		Utility::redirect("index.php");
	}
?>
...
<br style="clear:left"/>
    ...
    <div id="coluna2xx">
	  ...
	  <tr>
		...
		<div class="titulosPag">SocialWeb - Sistema de Assistência Social - Canal da Secretaria</div>
